...
constraint fk1 foreign key(CampusID)
 References Campus(`CampusID`)
 
on delete set null on update cascade);

insert into campus values
(1,'campusa','abc','Pak','Lhr',0),
(2,'campusb','abc','Pak','Lhr',1),

(3,'campusc','cde','Pak','Lhr',0),
(4,'campusd','bcd','Pak','kwl',1),
(5,'campuse','def','Pak','Mul',1);

insert into building values(1,'buildinga','abc',1),
(2,'buildingb','abc',1),
(3,'buildingc','bcd',2),
(4,'buildingd','cde',4),(5,'buildinge','def',3);
